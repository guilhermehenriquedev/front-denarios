...
var SelectDropdown = (function (_super) {
    ...
    function SelectDropdown() {
        ...
        _this.noOptionsMessage = function (obj) {
            ...
            if ((0, lodash_1.isNil)(selectProps)) {
                return null;
            }
            if ((0, lodash_1.isEmpty)(obj) || (0, lodash_1.isEmpty)(obj.inputValue)) {
        ...
        _this.isValidNewOption = function (inputValue) {
            if ((0, lodash_1.isEmpty)(inputValue)) {
                return false;
            }
    ...
    SelectDropdown.prototype.render = function () {
        ...
        var comps = (selectProps === null || selectProps === void 0 ? void 0 : selectProps.components) ? __assign(__assign({}, components), selectProps === null || selectProps === void 0 ? void 0 : selectProps.components) : components;
        if (selectProps === null || selectProps === void 0 ? void 0 : selectProps.isCreatable) {
            return ((0, jsx_runtime_1.jsx)(creatable_1.default, __assign({ inputId: inputId, isValidNewOption: this.isValidNewOption, captureMenuScroll: false, createOptionPosition: "first" }, selectProps, { value: value, placeholder: placeholder, options: options, styles: styles, noOptionsMessage: this.noOptionsMessage, onChange: onChange, onFocus: onFocus, onBlur: onBlur, components: comps }), void 0));
        }
        return ((0, jsx_runtime_1.jsx)(react_select_1.default, __assign({ inputId: inputId, isValidNewOption: this.isValidNewOption, captureMenuScroll: false, createOptionPosition: "first" }, selectProps, { value: value, placeholder: placeholder, options: options, styles: styles, noOptionsMessage: this.noOptionsMessage, onChange: onChange, onFocus: onFocus, onBlur: onBlur, components: comps }), void 0));
    };
    SelectDropdown.prototype.containsOptions = function (inputValue) {
        var _this = this;
        return (0, lodash_1.some)(this.props.options, function (option) { return _this.equalsIgnoringCase(inputValue, option.value); });
    };
    SelectDropdown.prototype.containsValue = function (inputValue) {
        ...
        return (0, lodash_1.some)(value, function (option) { return _this.equalsIgnoringCase(inputValue, option.value); });
    };
    SelectDropdown.prototype.equalsIgnoringCase = function (a, b) {
        return a.localeCompare((0, lodash_1.toString)(b), undefined, SelectDropdown.SENSITIVITY) === 0;
    };
